# Apple WLOC 网络定位修改工具 (wloc-locator)

> Apple WLOC (gs-loc) 网络定位修改与坐标注入工具，支持多代理模块及 Cloudflare Workers 选点面板。修改 Apple 网络定位（WLOC）返回的经纬度、精度和海拔。
...
| 工具 | 订阅链接 |
|------|----------|
| Surge | `https://raw.githubusercontent.com/admin0330/wloc-locator/refs/heads/main/modules/wloc.sgmodule` |
| Loon | `https://raw.githubusercontent.com/admin0330/wloc-locator/refs/heads/main/modules/wloc.lpx` |
| Stash | `https://raw.githubusercontent.com/admin0330/wloc-locator/refs/heads/main/modules/wloc.stoverride` |
| Quantumult X | `https://raw.githubusercontent.com/admin0330/wloc-locator/refs/heads/main/modules/wloc.conf` |
| Shadowrocket（小火箭） | `https://raw.githubusercontent.com/admin0330/wloc-locator/refs/heads/main/modules/wloc.module` |
...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/admin0330/wloc-locator/tree/main/worker)
...
`worker/wrangler.jsonc` 中默认 Worker 名称为 `wloc-locator`。如果 Cloudflare Dashboard 中已有 Worker 使用其他名称，请将配置文件中的 `name` 改成对应名称。
